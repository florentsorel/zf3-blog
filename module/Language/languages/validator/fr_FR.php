...
return [
    ...
    "Maximum allowed size for file is '%max%' but '%size%' detected" => "La taille maximale autorisée est %max%. Le fichier utilisé fait %size%",
    ...
    "File has an incorrect mimetype of '%type%'" => "Le fichier a un type incorrect ('%type%' n'est pas pris en charge)",
    ...
    "Value is required and can't be empty" => "Le champ est requis",
